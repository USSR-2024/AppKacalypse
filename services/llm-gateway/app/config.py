...
class Config:
    ...
    REQUEST_TIMEOUT: float = float(os.getenv("LLM_REQUEST_TIMEOUT", "240"))  # запас на холодную загрузку модели
    KEEP_ALIVE: str = os.getenv("OLLAMA_KEEP_ALIVE", "1h")  # сколько держать модель в VRAM
