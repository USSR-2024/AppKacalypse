...
# в образе vikunja нет wget/curl — проверяем с llm-gateway (python, та же сеть)
check "vikunja http"  "docker compose exec -T llm-gateway python -c \"import urllib.request; urllib.request.urlopen('http://vikunja:3456/api/v1/info')\""
